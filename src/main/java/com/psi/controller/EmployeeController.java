...
public class EmployeeController {
	...
	@Autowired
	private EmployeeRepository employeeRepostitory;
	
	// 部門維護首頁
	@GetMapping("/")
	public String index(@ModelAttribute Employee employee,  Model model) {
		model.addAttribute("_method", "POST");
		model.addAttribute("employees", employeeRepostitory.findAll());
	...
	public String get(@PathVariable("id") Long id, Model model) {
		...
		model.addAttribute("employee", employeeRepostitory.getById(id));
		model.addAttribute("employees", employeeRepostitory.findAll());
		model.addAttribute("departments", departmentRepository.findAll());
		return "employee";
	}
